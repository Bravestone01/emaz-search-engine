  ...
  return (
    <main className="min-h-screen bg-emaz-blue flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        ...
        <div className="w-full max-w-2xl mb-8">
          <div className="relative group">
            <input
              ...
              className="w-full p-4 pl-6 rounded-xl bg-white/5 border border-gray-800 text-white placeholder-gray-500 focus:outline-none focus:border-emaz-gold/50 focus:ring-2 focus:ring-emaz-gold/30 transition-all duration-300 group-hover:border-gray-600 shadow-lg shadow-black/20"
            />
          ...
          <div className="flex flex-wrap gap-3 justify-center mt-6">
            {['Technology', 'Science', 'Business', 'Health', 'Education'].map((tag) => (
              <button
                key={tag}
                className="px-4 py-2 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-lg text-sm transition-colors border border-white/5"
              >
                {tag}
              </button>
            ))}
        ...
        <div className="flex gap-4">
          <button className="px-8 py-3 bg-emaz-gold text-emaz-blue font-medium rounded-lg hover:bg-emaz-gold/90 hover:shadow-lg hover:shadow-emaz-gold/20 transition-all flex items-center gap-2">
          ...
          <button className="px-8 py-3 bg-white/5 text-white font-medium rounded-lg hover:bg-white/10 hover:shadow-lg border border-white/10 transition-all">
            Feeling Adventurous
          </button>
        </div>
